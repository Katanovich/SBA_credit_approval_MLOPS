...
@api_router.get("/health", response_model=schemas.Health, status_code=200, include_in_schema=True)
def health() -> dict:
...
async def predict(input_data: schemas.MultipleSBADataInputs) -> Any:
    """
